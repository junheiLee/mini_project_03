...
<body>
	<div id="wrap">
		...
		<header>
			<!--로고 들어가는 곳 시작--->
			<div id="logo">
				<a href="${contextPath}/NonageServlet?command=index"> <img
				...
				<ul>
					<c:choose>
						<c:when test="${empty sessionScope.loginUser}">
							<li><a href="${contextPath}/NonageServlet?command=login_form"
								style="width: 110px;">LOGIN(CUSTOMER</a> <a
								href="${contextPath}/NonageServlet?command=admin_login_form"
								style="width: 100px;">| ADMIN)</a></li>
							<li>/</li>
							<li><a href="${contextPath}/NonageServlet?command=contract">JOIN</a></li>
						</c:when>
						<c:otherwise>
							<li style="color: orange">
								${sessionScope.loginUser.name}(${sessionScope.loginUser.id})</li>
							<li><a href="${contextPath}/NonageServlet?command=logout">LOGOUT</a></li>
						</c:otherwise>
					</c:choose>
					<li>/</li>
					<li><a href="${contextPath}/NonageServlet?command=cart_list">CART</a></li>
					<li>/</li>
					<li><a href="${contextPath}/NonageServlet?command=mypage">MY PAGE</a></li>
					<li>/</li>
